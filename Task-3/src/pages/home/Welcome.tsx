...
import WelcomeImage from '../../assests/images/mbt.png'
      ...
      <Row style={{ color: 'white' }}>
        <ImageContainer xs={12} md={12}>
          <h4 style={{ textTransform: 'uppercase', fontSize: '1.7rem' }}>
            Welcome to Calendar Event Scheduler App
          </h4>
          <br />
          {/* <p>
            <a
          ...
          <div style={{ fontSize: '1.2rem' }}>
            <Row>
              <Col xs={6} md={6}>
                <p>
                  Calendar Event Scheduler is a fullstack React app that allows users to
